        ...
        <nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary fixed-top" data-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="https://svgsilh.com/svg/295350-ffffff.svg" alt="Bootstrap" width="30" height="24">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link${activeCatalogov1}" href="catalogov1.html">Productos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link${activeCatalogov2}" href="catalogov2.html">Accesorios</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link${activeCarroCompra} nav-link-btn" href="#" onclick="openCarrito()">Ver Carrito</a>
                        </li>                                                   
                    </ul>
                </div>
            </div>
