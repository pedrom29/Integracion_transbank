...
function  load(){
    ...
    const resp = fetch("assets/data2.json",{
                    //method: 'GET',
                    headers: {
                ...
                .then((response) => {
                    ...
                    const objJSON = JSON.parse(data2);
                                ...
                                <div class="col-sm m-3">
                                    <div class="card m-auto" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="text-left">$${objJSON[i].precio}</h6>
                    ...
                    console.log('OBTENER DIV CON id = catalogo2');
                    const catalogoHTML = document.getElementById("catalogo2");
